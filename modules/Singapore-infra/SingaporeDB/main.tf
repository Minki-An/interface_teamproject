...
data "aws_secretsmanager_secret_version" "rds_secret" { 
  #arn:aws:secretsmanager:ap-southeast-1:686167268975:secret:Terraform/RDS-fVZ5EX->rds 시크릿정보(사용자명,비번) 시크릿매니저로 관리
  secret_id = "arn:aws:secretsmanager:ap-southeast-1:686167268975:secret:Terraform/RDS-fVZ5EX"
}


#iam_role for RDS_Proxy
data "aws_iam_role" "RDS_Proxy_iam" {
  name = "rds-proxy-role-1685066491449"
}
